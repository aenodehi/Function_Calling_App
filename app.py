...
def get_time_in_timezone(timezone_name: str) -> str:
    """Returns the current time for a given timezone. Call this whenever you need to know the current time of any timezone, for example when a customer asks "What is the time in Tehran?"
